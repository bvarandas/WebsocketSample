...
namespace Gradual.Spider.Acompanhamento4Socket.Rede
{
    public class StreamerClientHandler
    {
        ...
        ConcurrentQueue<StreamerOrderInfo> _qOrd;
        Thread _thQueue;
        Thread _thSnapshot;
        bool _isRunning;
        ...
        {
            _qOrd = new ConcurrentQueue<StreamerOrderInfo>();
        ...
        public void CancelTransfer(bool valor)
        {
            ...
            StreamerOrderInfo  result;
            while (_qOrd.TryDequeue(out result));
        }
