...
namespace Gradual.Spider.ServicoSupervisor.Memory
{
    public class RiskClientManager
    {
        ...
        public void StartEventHandlersPositionClient()
        {
            //if (PositionClientManager.Instance.OnPositionClientUpdate == null)
            ...
            //if (ConsolidatedRiskManager.Instance.OnConsolidatedRiskUpdate == null)
        ...
        public void Start()
        {
            ...
            this.StartEventHandlersPositionClient();
