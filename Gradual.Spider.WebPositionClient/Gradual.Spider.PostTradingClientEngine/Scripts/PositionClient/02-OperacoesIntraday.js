...
var gOperacoesIntradayPrimeiroRequest = true;

var gOperacoesIntradayEhParaAtualizar = true;

var gOPeracoesIntradayTotalPL = 0;
...
function PositionClient_Operacoes_Intraday_Grid() {
    gGridOperacoesIntraday =
    {
      ...
      , autowidth: false
        //, shrinkToFit: false
      , colModel: [
                        { label: "Conta",       name: "CodigoCliente",          jsonmap: "CodigoCliente",           index: "CodigoCliente",         width: 65, align: "center", sortable: true, sorttype: 'int'  }
                      , { label: "Ativo",       name: "CodigoInstrumento",      jsonmap: "CodigoInstrumento",       index: "CodigoInstrumento",     width: 65, align: "center", sortable: true, sorttype: 'text' }
                      , { label: "Merc",        name: "Mercado",                jsonmap: "Mercado",                 index: "Mercado",               width: 55, align: "center", sortable: true, sorttype: 'text' }
                      , { label: "NomeCliente", name: "NomeCliente",            jsonmap: "NomeCliente",             index: "NomeCliente",           width: 75, align: "left"  , sortable: true }
                      , { label: "Qtd.Aber",    name: "QuantAbertura",          jsonmap: "QuantAbertura",           index: "QuantAbertura",         width: 75, align: "center", sortable: true, sorttype:'number'  ,formatter: 'number', formatoptions:{ decimalSeparator: ",", thousandsSeparator: ".", decimalPlaces: 0,  }}
                      , { label: "Qtd.Total",   name: "QuantTotal",             jsonmap: "QuantTotal",              index: "QuantTotal",            width: 75, align: "center", sortable: true, sorttype:'number'  ,formatter: 'number', formatoptions:{ decimalSeparator: ",", thousandsSeparator: ".", decimalPlaces: 0,  }}
                      , { label: "Cotação",     name: "Cotacao",                jsonmap: "Cotacao",                 index: "Cotacao",               width: 75, align: "center", sortable: true, sorttype: 'number', formatter: 'number', formatoptions: { decimalSeparator: ",", thousandsSeparator: ".", decimalPlaces: 2, } }
                      , { label: "P&L",         name: "PL",                     jsonmap: "PL",                      index: "PL",                    width: 75, align: "center", sortable: true, sorttype: 'number', formatter: 'number', formatoptions: { decimalSeparator: ",", thousandsSeparator: ".", decimalPlaces: 2, } }
                      , { label: "Qt.Exec.C",   name: "QuantExecutadaCompra",   jsonmap: "QuantExecutadaCompra",    index: "QuantExecutadaCompra",  width: 75, align: "center", sortable: true, sorttype:'number'  ,formatter: 'number', formatoptions: { decimalSeparator: ",", thousandsSeparator: ".", decimalPlaces: 0,  }}
                      , { label: "Qt.Exec.V",   name: "QuantExecutadaVenda",    jsonmap: "QuantExecutadaVenda",     index: "QuantExecutadaVenda",   width: 75, align: "center", sortable: true, sorttype:'number'  ,formatter: 'number', formatoptions: { decimalSeparator: ",", thousandsSeparator: ".", decimalPlaces: 0,  }}
                      , { label: "Net Qtde.",   name: "QuantExecutadaNet",      jsonmap: "QuantExecutadaNet",       index: "QuantExecutadaNet",     width: 85, align: "center", sortable: true, sorttype:'number'  ,formatter: 'number', formatoptions: { decimalSeparator: ",", thousandsSeparator: ".", decimalPlaces: 0,  }}
                      , { label: "Book Cpa",    name: "QuantAbertaCompra",      jsonmap: "QuantAbertaCompra",       index: "QuantAbertaCompra",     width: 65, align: "center", sortable: true, sorttype:'number'  ,formatter: 'number', formatoptions: { decimalSeparator: ",", thousandsSeparator: ".", decimalPlaces: 0,  }}
                      , { label: "Book Vda",    name: "QuantAbertaVenda",       jsonmap: "QuantAbertaVenda",        index: "QuantAbertaVenda",      width: 65, align: "center", sortable: true, sorttype:'number'  ,formatter: 'number', formatoptions: { decimalSeparator: ",", thousandsSeparator: ".", decimalPlaces: 0,  }}
                      , { label: "Net Book",    name: "QuantAbertaNet",         jsonmap: "QuantAbertaNet",          index: "QuantAbertaNet",        width: 65, align: "center", sortable: true, sorttype:'number'  ,formatter: 'number', formatoptions: { decimalSeparator: ",", thousandsSeparator: ".", decimalPlaces: 0,  }}
                      , { label: "Pç.Med.Cpa",  name: "PrecoMedioCompra",       jsonmap: "PrecoMedioCompra",        index: "PrecoMedioCompra",      width: 65, align: "center", sortable: true, sorttype:'number'  ,formatter: 'number', formatoptions: {  thousandsSeparator: ".",   }}
                      , { label: "Pç.Med.Vda",  name: "PrecoMedioVenda",        jsonmap: "PrecoMedioVenda",         index: "PrecoMedioVenda",       width: 65, align: "center", sortable: true, sorttype:'number'  ,formatter: 'number', formatoptions: {  thousandsSeparator: ".",   }}
                      , { label: "Vol Cpa",     name: "VolumeCompra",           jsonmap: "VolumeCompra",            index: "VolumeCompra",          width: 85, align: "center", sortable: true, sorttype:'number'  ,formatter: 'currency', formatoptions: { decimalSeparator: ",", thousandsSeparator: ".", decimalPlaces: 2, prefix: 'R$ ' }, }
                      , { label: "Vol Vda",     name: "VolumeVenda",            jsonmap: "VolumeVenda",             index: "VolumeVenda",           width: 85, align: "center", sortable: true, sorttype:'number'  ,formatter: 'currency', formatoptions: { decimalSeparator: ",", thousandsSeparator: ".", decimalPlaces: 2, prefix: 'R$ ' }, }
                      , { label: "Vol Tot",     name: "VolumeTotal",            jsonmap: "VolumeTotal",             index: "VolumeTotal",           width: 85, align: "center", sortable: true, sorttype:'number'  ,formatter: 'currency', formatoptions: { decimalSeparator: ",", thousandsSeparator: ".", decimalPlaces: 2, prefix: 'R$ ' } }
      ...
      , multiselect: true
      , loadComplete: Operacoes_intraday_Load_Complete
...
///Evento disparado do load complete da grid de operações intraday
function Operacoes_intraday_Load_Complete()
{
    OperacoesIntraday_SetTitle();//Grid Operações Intraday
}
...
function SetColorOperacoesIntradayInsertRow(rowid, pData) {
    ...
    */
    ...
    gOPeracoesIntradayTotalPL += pData.PL;
...
function PreparaGridOperacoesIntraday() {
    ...
    lGrid.jqGrid('setGroupHeaders', {
        ...
        groupHeaders: [{ startColumnName: 'CodigoCliente', numberOfColumns: 4, titleText: '' },
                       ...
                       { startColumnName: 'Cotacao', numberOfColumns: 1, titleText: '' },
...
function txtOperacoesIntraday_Cliente_KeyDown(pSender)
{
    ...
    }).one('keyup', function(e) 
    {
        if (e.keyCode == 8)
        {
            gOperacoesIntradayEhParaAtualizar = false;
        }
    });
}
...
///Método que envia a solicitação para desassinar 
function SendMessageUnsignatureOperacoesIntraday()
{
    var lMessageToSend = "UNSUBSCRIBE " + gLastClientSearchedOperacoesIntraday;
...
function OperacoesIntradayRemoveFiltersParametrosIntraday()
{
    ...
    $("#chkOperacoesIntradayNetIntradiarioPositivo").prop('checked', false);
    $("chk#OperacoesIntradayPLNegativo").prop('checked', false);

    return false;
}

//Evento disparado no remover click do bot~~ao de remover filtros
function OperacoesIntraday_Remover_Todos_Filtros_Click()
{
    $('#pnlOperacoesIntraday :input').filter(':text').val("");
    $('#pnlOperacoesIntraday :input').filter(':checkbox').prop('checked', false);
    ...
    SendMessageUnsignatureOperacoesIntraday();
...
function OperacoesIntradaySetRowDataObjectonGrid(pGrid, pObjeto) {
    ...
    OperacoesIntraday_SomaTotalPLSocket();
...
///Efetua a somatória da colina pl para calculo de Total PL
function OperacoesIntraday_SomaTotalPLSocket() {

    var lGrid = $("#jqGrid_OperacoesIntraday");

    var rowIds = lGrid.jqGrid('getDataIDs');

    var lTotalPL = 0;

    for (row = 1; row <= rowIds.length; row++)
    {
        rowData = lGrid.jqGrid('getRowData', row);

        lTotalPL += parseFloat( rowData["PL"]);
    }

    gOPeracoesIntradayTotalPL = lTotalPL;

    OperacoesIntraday_SetTitle();
}

///Método que esta a o header da grid
function OperacoesIntraday_SetTitle()
{
    $("#gview_jqGrid_OperacoesIntraday")
        .find(".ui-jqgrid-title")
        .html("<i>Operações Intraday-> Total PL: R$ " + gOPeracoesIntradayTotalPL.toFixed(2).toLocaleString('pt-BR') + "</i>");
}
...
function OperacoesIntraday_BuscarDados()
{
    ...
    gOperacoesIntradayEhParaAtualizar = true;

    gOPeracoesIntradayTotalPL = 0;
...
function OperacoesIntraday_TemporizadorRefresh_Grid() {
    ...
    gOperacoesIntradayUltimoRequest = lRequest;
...
function OperacoesIntraday_Verifica_Refresh() {
    ...
    if (!gOperacoesIntradayEhParaAtualizar) {
        return;
    }
    ...
    var lRetorno =
        {
            ...
            OpcaoParametroIntradayNetPositivo   : $("#chkOperacoesIntradayNetIntradiarioPositivo").is(':checked'),
...
///Método de callback de verificação de refresh
...
function OperacoesIntraday_REST_DataBind_Grid(pData) {
    ...
    lMock_Operacoes_Intraday.rows = [];

    for (i = 0; i < lData.length; i++)
    {
        PreencheMockOperacoesIntraday(lData[i]);
    }
    ...
    lGrid
        ...
        {
            datatype: 'local',
            data: lMock_Operacoes_Intraday.rows
        })
        .trigger("reloadGrid");
    
}

function PreencheMockOperacoesIntraday(pData)
{ 
    lMock_Operacoes_Intraday.rows.push(pData);
    /*
    lMock_Operacoes_Intraday.rows.push({
        CodigoCliente:          pData.CodigoCliente,
        CodigoInstrumento:      pData.CodigoInstrumento,   
        Mercado:                pData.Mercado,             
        Vencimento:             pData.Vencimento,          
        QuantAbertura:          pData.,       
        QuantTotal:             pData.,          
        PL:                     pData.,                  
        QuantExecutadaCompra:   pData.,
        QuantExecutadaVenda:    pData., 
        QuantExecutadaNet:      pData.,   
        QuantAbertaCompra:      pData.,   
        QuantAbertaVenda:       pData.,    
        QuantAbertaNet:         pData.,      
        PrecoMedioCompra:       pData.,    
        PrecoMedioVenda:        pData.,     
        VolumeCompra:           pData.,        
        VolumeVenda:            pData.,         
        VolumeTotal:            pData.,
    });*/
...
function Opcao_Net_Intradiario_Click(pSender)
{
    var lSender = $(pSender);

    if (lSender.attr('id') == 'chkOperacoesIntradayNetIntradiarioPositivo')
    {
        $("#chkOperacoesIntradayNetIntradiarioNegativo").prop('checked', false);
    }
    else if (lSender.attr('id') == 'chkOperacoesIntradayNetIntradiarioNegativo')
    {
        $("#chkOperacoesIntradayNetIntradiarioPositivo").prop('checked', false);
    }
