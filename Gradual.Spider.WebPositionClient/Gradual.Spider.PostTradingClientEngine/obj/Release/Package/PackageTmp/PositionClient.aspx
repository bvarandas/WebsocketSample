        ...
        <div class="col-md-11">
            <div class="row cabecalho-cliente">
                <div class="col-md-11 titulo">
                    ...
                    <span class="lblMensagem" ><label id="lblMensagemInfo"></label></span>
                    ...
                    <fieldset class="filter-border">
                        ...
                        <div class="row">
                            ...
                            <legend class="filter-border-small">Parametros do Intraday</legend>
                                ...
                                <div class="checkbox">
                                    <label>
                                    <input type="checkbox" id="chkOperacoesIntradayNetIntradiarioNegativo" onclick="return Opcao_Net_Intradiario_Click(this)" />Net Intradiário Negativo
                                    </label>
                                    <label class="align-to-right">*net Qtde < 0</label>
                                </div>
                                    <div class="checkbox">
                                    <label>
                                    <input type="checkbox" id="chkOperacoesIntradayNetIntradiarioPositivo" onclick="return Opcao_Net_Intradiario_Click(this)"/>Net Intradiário Positivo
                                    </label>
                                    <label class="align-to-right">*net Qtde > 0</label>
                                </div>
                                <div class="checkbox">
                    ...
                    <legend class="filter-border">Filtros</legend>
                        <div class="row">
                            ...
                            <legend class="filter-border-small">% SFP Atingido</legend>
                                ...
                                <div class="pull-right">
                                    <a href="#" onclick="return RiscoResumido_RemoverFiltros_SFPAtingido_Click(this)"> Remover Filtro </a>
                                </div>
                            ...
                            <legend class="filter-border-small">R$ Prejuízo Atingido (PL Total)</legend>
                                ...
                                <div class="pull-right">
                                    <a href="#" onclick="return RiscoResumido_RemoverFiltros_PrejuizoAtingido_Click(this)"> Remover Filtro </a>
                                </div>
                            </fieldset>
                            </div>
                            <div class="col-sm-2">
