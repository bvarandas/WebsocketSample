...
function Page_Load()
{
    ...
    RiscoResumido_Bind_Event_Click();
...
function Spider_TratarRespostaComErro(pResposta, pPainelParaAtualizar) {
...
function Spider_ExibirMensagem(pTipo_IAE, pMensagem, pRetornarAoEstadoNormalAposSegundos, pMensagemAdicional) {
    ...
    $("#lblMensagemInfo").html(pMensagem);
...
function ManterSessao()
{
    ...
    Spider_CarregarJsonVerificandoErro("PositionClient.aspx"
                                         , lDados
