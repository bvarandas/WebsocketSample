<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="Gradual.Spider.PositionClient.Monitor.Test.Www.Account.OpenAuthProviders" %>
